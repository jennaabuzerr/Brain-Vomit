function BrainIcon({ color = "var(--brain-pink)", fill = "#ffe0ec", width = 260 }) {  return (
    ...
    >
      ...
      />
      <path
        d="M 40 55 C 45 60, 45 68, 40 72" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round"
      />
      <path
        d="M 160 55 C 155 60, 155 68, 160 72" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round"
      />
    </svg>
  );
}

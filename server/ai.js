...
async function categorizeTask(rawText) {
    ...
    const instruction = `Categorize this task. Choose one category from: School, Events, Self Care, Clubs/Orgs, Chores. Choose a priority from: High, Medium, Low. Display deadline date. Respond with only JSON containing these fields: name, deadline, category, priority. Use ${today} for today's date and demand the deadline to be formatted as YYYY-MM-DD.`;
